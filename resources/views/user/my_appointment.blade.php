...
<body>
  ...
  <div align="Center" style="padding: 20px;">
  	<table style=" width: 1000px;">
  		<tr style="background-color: #808080;" align="Center">
  			...
  			<th style="padding: 20px; font-style: normal; font-size: 15px;color: white;"> Ststus</th>
  			<th style="padding: 20px; font-style: normal; font-size: 15px;color: white;">Cancel Appointment</th>
  		</tr>
  		@foreach($appoint as $appoints)
  		<tr style="background-color: #EBECF0;" align="Center">
